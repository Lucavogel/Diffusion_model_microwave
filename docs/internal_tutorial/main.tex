...
\hypersetup{
  ...
  citecolor=lirmmblue,
  urlcolor=lirmmblue,
  pdftitle={MuJoCo Simulation Tutorial: Teleoperation, Data Recording, and Policy Deployment},
...
\begin{titlepage}
  ...
  \vspace{1.5cm}
  {\Huge\bfseries\color{lirmmblue} MuJoCo Simulation Tutorial\par}
  \vspace{0.5cm}
  {\LARGE Teleoperation, Data Recording, and Policy Deployment\par}
  \vspace{1.2cm}
